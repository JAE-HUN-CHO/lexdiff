...
const scenarios = [
  ...
  },
  {
    ...
    expectedDomainTools: ['search_ai_law', 'search_admin_appeals'],
    minAnswerLen: 200,
  },
  {
  ...
  // ══════ 9. 사내 변호사 자문 (10개) — 복합 분석/해석/분쟁 대비 ══════
  {
    ...
    expectedDomainTools: ['search_ai_law', 'search_precedents'],
    minAnswerLen: 300,
  },
  {
  ...
  },
  {
    ...
    expectedDomainTools: ['search_ai_law', 'search_ftc_decisions'],
    minAnswerLen: 300,
  },
  {
